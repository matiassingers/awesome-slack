...
- [nuntius](https://github.com/roysegall/nuntius-bot) - PHP framework with plugable RTM events, triggered tasks by the user input, webhooks intergration and a lot of cool stuff. 
